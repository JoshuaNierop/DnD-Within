...
- [ ] P3 — Cosmetisch: unsigned preset negeert ons `dnd-within/...` pad en geeft elke asset een random public_id → alles plat in Cloudinary-root, geen mappenstructuur in Media Library. Functioneel geen probleem (URL wordt opgeslagen). Optioneel later fixen door preset/signed-upload aan te passen.
